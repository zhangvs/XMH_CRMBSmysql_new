...
{
    public partial class ssn_article : System.Web.UI.Page
    {
        ...
        public void bindArticle(string title)
        {
            ...
            if (!string.IsNullOrEmpty(Request.QueryString["Id"].ToString()))
            {
                ...
                DataSet dk = _visit.GetListAtrId("r.empID='" + empId + "'and v.Menu_ids='" + menuId + "' ");
                ...
                if (uid != "admin")
                {
                    ...
                    {
                        string Menu_ids = dk.Tables[0].Rows[0]["Menu_ids"].ToString();
                    ...
                    if (num == true)
                    {
                        string atr_id = PageValidate.InputText(dk.Tables[0].Rows[0]["Art_id"].ToString(), int.MaxValue).Replace("a", "");
