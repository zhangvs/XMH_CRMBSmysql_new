<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ssn_menu_add.aspx.cs" Inherits="SSN.SSN.system.ssn_menu_add" %>
        ...
        function loadForm(oaid) {
            $.ajax({
                ...
                success: function (result) {
                    ...
                    //$("#T_menu_type").ligerGetComboBoxManager().selectValue(obj.Menu_type);
                    $("#menuicon").attr("src", "../../" + obj.Menu_icon);
                    initcomb(obj.parentid);
                    if (getparastr("parentid") == '0')
                        $("#T_menu_parent").ligerGetComboBoxManager().setReadOnly();
                }
            });
        }
        function initcomb(value) {
            ...
            if (value) {
                $("#T_menu_parent").ligerComboBox({
                    ...
                    treeLeafOnly: true,
                    tree: {
                        url: '../../DataSSN/SSN_Menu.ashx?Action=SysTree&appid=1&rnd=' + Math.random(),
                        idFieldName: 'id',
