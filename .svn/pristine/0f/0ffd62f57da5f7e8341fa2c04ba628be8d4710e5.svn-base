    ...
    public partial class shop_region
    {
        ...
        public bool Exists(int region_id)
        {
            ...
            MySqlParameter[] parameters = {
					new MySqlParameter("@region_id", MySqlDbType.Int32,5)			};
        ...
        public bool Add(XHD.Model.shop_region model)
        {
            ...
            MySqlParameter[] parameters = {
					new MySqlParameter("@region_id", MySqlDbType.Int32,5),
					new MySqlParameter("@parent_id", MySqlDbType.Int32,5),
					new MySqlParameter("@region_name", MySqlDbType.Int32,120),
					new MySqlParameter("@region_type", MySqlDbType.Int32,1),
        ...
        public XHD.Model.shop_region GetModel(int region_id)
        {
            ...
            XHD.Model.shop_region model = new XHD.Model.shop_region();
        ...
        /// 得到一个对象实体
        /// </summary>
        public XHD.Model.shop_region DataRowToModel(DataRow row)
        {
            XHD.Model.shop_region model = new XHD.Model.shop_region();
            if (row != null)
            {
