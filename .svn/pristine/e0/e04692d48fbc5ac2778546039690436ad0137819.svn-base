...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#maingrid4").ligerGrid({
                columns: [
                    ...
                    { display: '基数', name: 'brand_base', width: 80 },
                    { display: '计划', name: 'brand_plan', width: 80 },

                ],

                dataAction: 'server',
                pageSize: 30, pageSizeOptions: [30, 60, 90],
        ...
        function edit() {
            ...
            if (row) {
                $("#id").val(row.id);
                $("input[name='brand_id']").val(row.brand_id);
                $("input[name='brand_name']").val(row.brand_name);
                $("input[name='emp_code']").val(row.emp_code);
                $("input[name='name']").val(row.name);
                $("input[name='brand_base']").val(row.brand_base);
                $("input[name='brand_plan']").val(row.brand_plan);
                show();
            }
            else {
        ...
        function clearTxt() {
            ...
            $("input[name='name']").val('');
            $("input[name='brand_base']").val('');
            $("input[name='brand_plan']").val('');
    ...
    <form id="form1" onsubmit="return false">
        ...
        <div class="dialog open" id="prodown" style="display: none; position: fixed; width:250px; z-index: 9999; background: #fff;">
            ...
            <div class="dialog-body line">
                ...
                <input type="text" id="brand_id" name="brand_id" style="display:none" />
                ...
                <table>
                    ...
                    <tr>
                        <td>品牌：</td>
                        <td>
                            <input type="text" style="text-align:right;" name="brand_name" value=" " /></td>
                    </tr>
                    <tr>
                        <td>基数：</td>
                        <td>
                            <input type="text" style="text-align:right;" name="brand_base" value=" " /></td>
                    </tr>
                    <tr>
                        <td>计划：</td>
                        <td>
                            <input type="text" style="text-align:right;" name="brand_plan" value=" " /></td>
                    </tr>
                </table>
