...
<head>
    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("#T_sex").ligerGetComboBoxManager().setReadOnly();
        });
        ...
        function loadForm(oaid) {
            $.ajax({
                ...
                success: function (result) {
                    ...
                    $("#userheadimg").attr("src", "http://172.178.1.211:8087/images/upload/portrait/" + obj.title);
                }
            });
        }
        ...
        function saveheadimg(item, dialog) {
            ...
            if (upfile) {
                ...
                $.ajax({
                    url: "../datassn/upload.ashx", type: "POST",
                    data: upfile,
        ...
        function f_save() {
            if ($(form1).valid()) {
                ...
                $.ajax({
                    url: "../datassn/ssn_data.ashx", type: "POST",
                    data: issave,
                    success: function (responseText) {
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <div style="text-align: center">
                            <input type="button" value="上传头像" style="width: 80px; height: 22px;" onclick="uploadimg()" disabled="disabled" />
                        </div>
