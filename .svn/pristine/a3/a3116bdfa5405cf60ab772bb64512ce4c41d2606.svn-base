<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ssn_role_add.aspx.cs" Inherits="SSN.SSN.system.ssn_role_add" %>
                    ...
                    <td height="23" class="style1">
                        <div style="float: left; height: 20px;">
                            <input type="text" id="T_role" name="T_role" ltype="text" ligerui="{width:250}"
                                validate="{required:true,maxlength:25,remote:'../../../DataSSN/SSN_Role.ashx?Action=Exist',messages:{required:'请输入角色名',remote:'角色名已经存在!'}}" />
