...
<head>
    ...
    <script src="../../JS/dmsCustomerManager.js" type="text/javascript"></script>
     <style type="text/css">
        table.dataView {
    ...
    <script type="text/javascript">
        ...
        function doserch() {
            ...
            $.ajax({
                ...
                data: { Action: "getCustomerMonthSaleBackData_Manager", idlist: tree1, syear: syear, smonth: smonth, rnd: Math.random() },
                dataType: 'json',
...
<body >
    ...
    <script type="text/javascript">
            function form_top() {
                document.write('<div id="form_top"><a href="#main00" title="回到顶部"><div class="top_img"></div></a></div>')
            }
            form_top();
    </script> 
</body>
