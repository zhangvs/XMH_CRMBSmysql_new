...
namespace XHD.DAL.ims
{
    ...
    public partial class ims_emp_score
    {
        ...
        public int Add(XHD.Model.ims.ims_emp_score model)
        {
            ...
            strSql.Append("id,Factory_Id,d_id,d_name,emp_id,emp_name,rule_id,rule_name,isPlus,score,check_empId,check_empName,check_date,check_remark,score_source,complaint_id,operate_date)");
            ...
            MySqlParameter[] parameters = {
                    ...
                    new MySqlParameter("@operate_date",MySqlDbType.DateTime) };
            ...
            parameters[16].Value = model.operate_date;
        ...
        public XHD.Model.ims.ims_emp_score GetModel(int id)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select id,Factory_Id,d_id,d_name,emp_id,emp_name,rule_id,isPlus,score,check_empId,check_empName,check_date,check_remark,score_source,complaint_id,operate_date from ims_emp_score ");
            strSql.Append(" where id=@id ");
            MySqlParameter[] parameters = {
					new MySqlParameter("@id", MySqlDbType.Int32,11)			};
            parameters[0].Value = id;
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select id,Factory_Id,d_id,d_name,emp_id,emp_name,rule_id,rule_name,isPlus,score,check_empId,check_empName,check_date,check_remark,score_source,complaint_id,operate_date ");
