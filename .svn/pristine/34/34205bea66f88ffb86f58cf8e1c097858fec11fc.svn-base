...
namespace XHD.DAL
{
    ...
    public partial class shop_order_info
    {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into shop_order_info(");
            ...
            MySqlParameter[] parameters = {
					...
					new MySqlParameter("@shipping_id", MySqlDbType.Int32,5),
					...
					new MySqlParameter("@wuliu_id", MySqlDbType.Int32,5),
					new MySqlParameter("@wuliu_name", MySqlDbType.VarChar,255),
					...
					new MySqlParameter("@invoice_id", MySqlDbType.Int32,6),
					...
					new MySqlParameter("@is_invoice_advance", MySqlDbType.Int32,1)};
            ...
            parameters[59].Value = model.wuliu_id;
            parameters[60].Value = model.wuliu_name;
            parameters[61].Value = model.need_inv;
            parameters[62].Value = model.is_send2_erp;
            parameters[63].Value = model.is_send2_cwerp;
            parameters[64].Value = model.is_wuliu_img;
            parameters[65].Value = model.get_pay_type;
            parameters[66].Value = model.is_daifa;
            parameters[67].Value = model.is_no_qingdan;
            parameters[68].Value = model.admin_user_id;
            parameters[69].Value = model.admin_user_name;
            parameters[70].Value = model.admin_user_real_name;
            parameters[71].Value = model.send_user_name;
            parameters[72].Value = model.send_user_tel;
            parameters[73].Value = model.send_user_company;
            parameters[74].Value = model.send_user_address;
            parameters[75].Value = model.cangku_id;
            parameters[76].Value = model.payinfo_pic;
            parameters[77].Value = model.is_confirm_remind;
            parameters[78].Value = model.is_print_remind;
            parameters[79].Value = model.order_ip;
            parameters[80].Value = model.cwerp_time;
            parameters[81].Value = model.erp_time;
            parameters[82].Value = model.is_need_review;
            parameters[83].Value = model.review_info;
            parameters[84].Value = model.Operator;
            parameters[85].Value = model.det_stats;
            parameters[86].Value = model.dealer_id;
            parameters[87].Value = model.is_show_price;
            parameters[88].Value = model.operator_user_id;
            parameters[89].Value = model.invoice_weight;
            parameters[90].Value = model.order_confirm_info;
            parameters[91].Value = model.invoice_id;
            parameters[92].Value = model.wms_setbook_id;
            parameters[93].Value = model.wms_doc_id;
            parameters[94].Value = model.wms_account_flag;
            parameters[95].Value = model.wms_receive_note;
            parameters[96].Value = model.wms_flow_no;
            parameters[97].Value = model.wms_finish_amout;
            parameters[98].Value = model.wms_unfinish_amout;
            parameters[99].Value = model.wms_invoice_type;
            parameters[100].Value = model.wms_account_type;
            parameters[101].Value = model.wms_voucher;
            parameters[102].Value = model.wms_amount;
            parameters[103].Value = model.wms_storage;
            parameters[104].Value = model.supply_user_id;
            parameters[105].Value = model.is_invoice_advance;
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update shop_order_info set ");
            ...
            parameters[58].Value = model.wuliu_id;
            parameters[59].Value = model.wuliu_name;
            ...
            parameters[83].Value = model.Operator;
            parameters[84].Value = model.det_stats;
            parameters[85].Value = model.dealer_id;
            parameters[86].Value = model.is_show_price;
            parameters[87].Value = model.operator_user_id;
            parameters[88].Value = model.invoice_weight;
            parameters[89].Value = model.order_confirm_info;
            parameters[90].Value = model.invoice_id;
            parameters[91].Value = model.wms_setbook_id;
            parameters[92].Value = model.wms_doc_id;
            parameters[93].Value = model.wms_account_flag;
            parameters[94].Value = model.wms_receive_note;
            parameters[95].Value = model.wms_flow_no;
            parameters[96].Value = model.wms_finish_amout;
            parameters[97].Value = model.wms_unfinish_amout;
            parameters[98].Value = model.wms_invoice_type;
            parameters[99].Value = model.wms_account_type;
            parameters[100].Value = model.wms_voucher;
            parameters[101].Value = model.wms_amount;
            parameters[102].Value = model.wms_storage;
            parameters[103].Value = model.supply_user_id;
            parameters[104].Value = model.is_invoice_advance;
            parameters[105].Value = model.order_id;
        ...
        public XHD.Model.shop_order_info GetModel(int order_id)
        {
            ...
            XHD.Model.shop_order_info model = new XHD.Model.shop_order_info();
        ...
        /// 得到一个对象实体
        /// </summary>
        public XHD.Model.shop_order_info DataRowToModel(DataRow row)
        {
            XHD.Model.shop_order_info model = new XHD.Model.shop_order_info();
            if (row != null)
            {
                ...
                if (row["bonus_id"] != null && row["bonus_id"].ToString() != "")
                {
                    model.bonus_id = int.Parse(row["bonus_id"].ToString());
                }
                ...
                if (row["operator_user_id"] != null && row["operator_user_id"].ToString() != "")
                {
                    model.operator_user_id = int.Parse(row["operator_user_id"].ToString());
                }
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select oi.order_id,oi.order_sn,oi.wms_order_sn,oi.erp_order_sn,oi.cwerp_order_sn,oi.user_id,oi.order_status,oi.shipping_status,oi.pay_status,oi.consignee,oi.country,oi.province,oi.city,oi.district,oi.address,oi.role_id,oi.user_market_area,oi.zipcode,oi.tel,oi.mobile,oi.email,oi.postscript,oi.order_note,oi.shipping_id,oi.shipping_name,oi.is_no_shipping_fee,oi.pay_id,oi.pay_name,oi.trans_bank_id,oi.trans_bank_name,oi.inv_payee,oi.inv_content,oi.goods_amount,oi.shipping_fee,oi.insure_fee,oi.pay_fee,oi.pack_fee,oi.money_paid,oi.surplus,oi.integral,oi.integral_money,oi.bonus,oi.order_amount,oi.from_ad,oi.referer,oi.add_time,oi.confirm_time,oi.pay_time,oi.shipping_time,oi.pack_id,oi.card_id,oi.bonus_id,oi.invoice_no,oi.to_buyer,oi.pay_note,oi.agency_id,oi.inv_type,oi.tax,oi.discount,oi.wuliu_id,oi.wuliu_name,oi.need_inv,oi.is_send2_erp,oi.is_send2_cwerp,oi.is_wuliu_img,oi.get_pay_type,oi.is_daifa,oi.is_no_qingdan,oi.admin_user_id,oi.admin_user_name,oi.admin_user_real_name,oi.send_user_name,oi.send_user_tel,oi.send_user_company,oi.send_user_address,oi.cangku_id,oi.payinfo_pic,oi.is_confirm_remind,oi.is_print_remind,oi.order_ip,oi.cwerp_time,oi.erp_time,oi.is_need_review,oi.review_info,oi.operator,oi.det_stats,oi.dealer_id,oi.is_show_price,oi.operator_user_id,oi.invoice_weight,oi.order_confirm_info,oi.invoice_id,oi.wms_setbook_id,oi.wms_doc_id,oi.wms_account_flag,oi.wms_receive_note,oi.wms_flow_no,oi.wms_finish_amout,oi.wms_unfinish_amout,oi.wms_invoice_type,oi.wms_account_type,oi.wms_voucher,oi.wms_amount,oi.wms_storage,oi.supply_user_id,oi.is_invoice_advance,oi.max_debt_days,oi.parent_order_id,oi.reviewer_emp_code1,oi.reviewer_emp_code2,oi.order_message, ");
            strSql.Append(" ct.C_tel,ct.C_name,cr.customer,ct.ec_is_bill_list,ct.ec_is_bill_list_show_price,ct.ec_is_daifa,ct.is_invoice_change,");
            strSql.Append(" ct.ec_daifa_user_name,ct.ec_daifa_phone,ct.ec_daifa_company,ct.ec_daifa_address,oi2.order_id parentid,oi2.order_sn parentsn,oi2.user_id parenttid,");
            ...
            strSql.Append(" inner join crm_contact as ct on oi.user_id=ct.id");
            strSql.Append(" inner join crm_customer as cr on ct.C_customerid=cr.id");
            strSql.Append(" left join xmh_shop.shop_order_info as oi2 on oi.parent_order_id=oi2.order_id");
            strSql.Append(" left join xmh_shop.shop_region as r1 on oi.province=r1.region_id");
            strSql.Append(" left join xmh_shop.shop_region as r2 on oi.city=r2.region_id");
            strSql.Append(" left join xmh_shop.shop_region as r3 on oi.district=r3.region_id");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
            }
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(")AS Row, T.*  from shop_order_info T ");
        ...
        public DataSet GetMyOrder(int PageSize, int PageIndex, string strWhere, string sqlOne, string sqlTwo, string filedOrder, out string Total)
        {
            ...
            strSql.Append("select oi.*,r1.region_name province_name,r2.region_name city_name,r3.region_name district_name,ct.C_name,ct.C_tel,cr.customer ");//,oa.status,oa.id apply_id,oa.apply_name,oa.apply_date,oa.apply_date
            strSql.Append("  FROM xmh_shop.shop_order_info  oi ");
            if (sqlTwo.Trim() != "")
            {
                strSql.Append(" INNER JOIN (SELECT order_id FROM xmh_shop.shop_order_goods where " + sqlTwo + " GROUP BY order_id) og on oi.order_id=og.order_id ");
            }
            strSql.Append(" INNER JOIN crm_contact ct ON oi.user_id = ct.id  ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" and " + strWhere);
            }
            strSql.Append(" INNER JOIN crm_customer cr ON ct.C_customerid = cr.id " + sqlOne);
            strSql.Append(" LEFT join xmh_shop.shop_region as r1 on oi.province=r1.region_id");
            strSql.Append(" LEFT join xmh_shop.shop_region as r2 on oi.city=r2.region_id");
            strSql.Append(" LEFT join xmh_shop.shop_region as r3 on oi.district=r3.region_id");
            //strSql.Append(" LEFT join crm_order_apply as oa on oa.order_id=oi.order_id and oa.isvalid=1");

            strSql1.Append("select count(1) ");
            strSql1.Append(" FROM xmh_shop.shop_order_info  oi ");
            if (sqlTwo.Trim() != "")
            {
                strSql1.Append(" INNER JOIN (SELECT order_id FROM xmh_shop.shop_order_goods where " + sqlTwo + " GROUP BY order_id) og on oi.order_id=og.order_id ");
            }
            strSql1.Append(" INNER JOIN crm_contact ct ON oi.user_id = ct.id  ");
            if (strWhere.Trim() != "")
            {
                strSql1.Append(" and " + strWhere);
            }
            strSql1.Append(" INNER JOIN crm_customer cr ON ct.C_customerid = cr.id " + sqlOne);
        ...
        public DataSet GetMyOrderTms(int PageSize, int PageIndex, string strWhere, string sqlOne, string sqlTwo, string filedOrder, out string Total)
        {
            StringBuilder strSql = new StringBuilder();
            StringBuilder strSql1 = new StringBuilder();
            strSql.Append("select tms.shipname,tms.item_count,oi.*,r1.region_name province_name,r2.region_name city_name,r3.region_name district_name,ct.C_name,ct.C_tel,cr.customer ");//,oa.status,oa.id apply_id,oa.apply_name,oa.apply_date,oa.apply_date
            strSql.Append("  FROM xmh_shop.shop_order_info  oi ");
            ...
            strSql.Append(" LEFT join xmh_shop.shop_region as r2 on oi.city=r2.region_id");
            strSql.Append(" LEFT join xmh_shop.shop_region as r3 on oi.district=r3.region_id");
            strSql.Append(" INNER join xmh_wms.tms_dispatch_order as tms on tms.order_sn=oi.order_sn and tms.state=0 " + sqlTwo);
            ...
            strSql1.Append(" INNER JOIN crm_customer cr ON ct.C_customerid = cr.id " + sqlOne);
            strSql1.Append(" INNER join xmh_wms.tms_dispatch_order as tms on tms.order_sn=oi.order_sn and tms.state=0 " + sqlTwo);
        ...
        public DataSet GetCheckOrder(int PageSize, int PageIndex, string strWhere, string sqlOne, string filedOrder, out string Total)
        {
            StringBuilder strSql = new StringBuilder();
            StringBuilder strSql1 = new StringBuilder();
            strSql.Append("select oi.*,r1.region_name province_name,r2.region_name city_name,r3.region_name district_name,ct.C_name,ct.C_tel,cr.customer ");//,oa.status,oa.id apply_id,oa.apply_name,oa.apply_date,oa.reason
            strSql.Append(" FROM xmh_shop.shop_order_info  oi ");
            strSql.Append(" INNER JOIN crm_contact ct ON oi.user_id = ct.id  ");
            if (strWhere.Trim() != "")
            {
            ...
            strSql.Append(" LEFT join xmh_shop.shop_region as r2 on oi.city=r2.region_id");
            strSql.Append(" LEFT join xmh_shop.shop_region as r3 on oi.district=r3.region_id");
            //strSql.Append(" INNER join crm_order_apply as oa on oa.order_id=oi.order_id and oa.isvalid=1");
            ...
            strSql1.Append(" INNER JOIN crm_customer cr ON ct.C_customerid = cr.id " + sqlOne);
            //strSql1.Append(" INNER join crm_order_apply as oa on oa.order_id=oi.order_id and oa.isvalid=1");
        ...
        public DataSet GetList2(int PageSize, int PageIndex, string strWhere, string filedOrder, out string Total)
        {
            StringBuilder strSql = new StringBuilder();
            StringBuilder strSql1 = new StringBuilder();
            strSql.Append("select o.order_id,o.order_sn,o.user_id,o.order_status,o.shipping_status,o.pay_status,o.add_time,o.consignee,o.tel,o.province, r1.region_name province_name,o.city,r2.region_name city_name,o.district,r3.region_name district_name,o.address,o.goods_amount,o.order_amount,c.C_tel user_name,c.C_customername u_company,c.C_name u_real_name FROM xmh_shop.shop_order_info as o");
            strSql.Append(" inner join crm_contact as c on o.user_id = c.id");
            ...
            strSql1.Append(" select count(1) FROM xmh_shop.shop_order_info as o inner join crm_contact as c on o.user_id = c.id ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
        ...
        public DataSet GetList(int PageSize,int PageIndex,string strWhere)
        {
            ...
            parameters[0].Value = "shop_order_info";
