<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ssn_article.aspx.cs" Inherits="SSN.SSN.article.ssn_article" %>
...
<head runat="server">
    ...
    <style type="text/css">
        .l-toolbar {width: 1800px;height: 32px;}
        .l-toolbar-item {margin-top: 4px;}
        .l-panel-label { margin-left: 20px;}
    </style>
</head>
<body>
