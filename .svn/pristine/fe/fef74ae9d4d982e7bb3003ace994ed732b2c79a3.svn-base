    ...
    <script type="text/javascript">
        ...
        function DrawEChart(ec) {
            ...
            myChart.on('click', function (params) {
                window.open('/DMS/ReportForm/dms_map_city_year_details.aspx?syear=' + $("#syear").val() + '&CityId=' + params.data.id + '&CityName=' + params.data.name + '&CityValue=' + params.data.value[2] + '&brandIdList=' + brandId + '&brandText=' + brandText + '&goodTextBox=' + goodTextBox + '&rnd=' + Math.random());
