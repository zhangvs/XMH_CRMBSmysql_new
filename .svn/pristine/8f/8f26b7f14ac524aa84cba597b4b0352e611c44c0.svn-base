...
<head>
    ...
    <script type="text/javascript">
        ...
        function doserch() {
            ...
            var sendtxt = "&Action=getBrandCheck&idlist=" + tree0 + "&brandIdList=" + tree1 + "&rnd=" + Math.random();
    ...
    <form id="form1" onsubmit="return false">
        ...
        <div class="dialog open" id="prodown" style="display: none; position: fixed; width:600px; z-index: 9999; background: #fff;">
            ...
            <div class="dialog-body line">
                ...
                客服：<span style="font-size: 12px; font-weight: bold; color: green" id="bc_real_name_span"> </span>品牌：<span id="bc_brand_name_span" style="font-size: 12px; font-weight: bold; color: blue"></span>
