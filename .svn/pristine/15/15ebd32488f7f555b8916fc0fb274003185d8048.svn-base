    ...
    public class GetAuthorityByUid
    {
        ...
        private string GetApp(string empID)
        {
            ...
            else
            {
                ...
                DataSet ds = auth.GetList("(Menu_ids!='' and Role_ID in " + RoleIDs + " and Type=0) or (Menu_ids!='' and Role_ID=" + int.Parse(empID) + " and Type=1)");
                if (ds.Tables[0].Rows.Count > 0)
                {
                    string Apps = "(";
                    for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
        ...
        private string GetMenus(string empID)
        {
            ...
            else
            {
                ...
                DataSet ds = auth.GetList("(Role_ID in " + RoleIDs + " and Type=0) or (Role_ID=" + int.Parse(empID) + " and Type=1)");
                if (ds.Tables[0].Rows.Count > 0)
                {
                    string Menus = "(";
                    for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
