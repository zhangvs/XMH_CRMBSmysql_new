...
namespace XHD.BLL
{
	...
	{
		private readonly XHD.DAL.shop_purchase_log dal=new XHD.DAL.shop_purchase_log();
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public XHD.Model.shop_purchase_log GetModelByCache(int aid)
		{
			
			string CacheKey = "shop_purchase_logModel-" + aid;
			...
			return (XHD.Model.shop_purchase_log)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<XHD.Model.shop_purchase_log> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<XHD.Model.shop_purchase_log> DataTableToList(DataTable dt)
		{
			List<XHD.Model.shop_purchase_log> modelList = new List<XHD.Model.shop_purchase_log>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				XHD.Model.shop_purchase_log model;
