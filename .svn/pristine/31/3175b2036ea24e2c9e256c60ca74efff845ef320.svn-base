...
namespace XHD.BLL
{
    ...
    public partial class CRM_Customer
    {
        ...
        {
            return dal.GetListBills(PageSize, PageIndex, strWhere,strSqlTwo, filedOrder, out Total);
        }
        ...
        {
            return dal.GetListContact1(PageSize, PageIndex, strWhere, key, filedOrder, out Total);
        }
