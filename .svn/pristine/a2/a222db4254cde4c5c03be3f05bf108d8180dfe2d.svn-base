...
$(function () {
    if (jQuery.validator) {
        ...
        jQuery.validator.addMethod("allphone", function (value, element) {
            //var tel800 = /^800\-[\d|\-]{7}[\d]{1}$/;
            //var tel400 = /^400\-[\d|\-]{7}[\d]{1}$/;
            var tel4 = /^(4|8)00(\d{4,8})$/;
            var telfax = /^(([0\+]\d{2,3})?(0\d{2,5}))(\d{7,8})(-(\d{3,}))?$/;
            var telphone = /^1[3|4|5|7|8][0-9]\d{8}$/;
            return this.optional(element) || (tel4.test(value)) || (telfax.test(value)) || (telphone.test(value));
        }, "请正确填写电话号码");
