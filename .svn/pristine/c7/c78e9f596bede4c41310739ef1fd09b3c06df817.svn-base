...
{
    /// <summary>
    /// crm_contact_end:实体类(属性说明自动提取数据库字段的描述信息)
    /// </summary>
    [Serializable]
    public partial class crm_contact_end
    {
        ...
        private int? _c_customerid_end;
        private string _c_customername_end;
        ...
        /// 
        /// </summary>
        public int? C_customerid_end
        {
            set { _c_customerid_end = value; }
            get { return _c_customerid_end; }
        }
        /// <summary>
        /// 
        /// </summary>
        public string C_customername_end
        {
            set { _c_customername_end = value; }
            get { return _c_customername_end; }
        }
        /// <summary>
        /// 
        /// </summary>
