    ...
    <script type="text/javascript">
        ...
        function DrawEChart(ec) {
            ...
            myChart.on('click', function (params) {
                window.open('/DMS/ReportForm/dms_map_province_month_details.aspx?syear=' + $("#syear").val() + '&smonth=' + $("#smonth").val() + '&provinceId=' + params.data.id + '&provinceName=' + params.data.name + '&provinceValue=' + params.data.value + '&brandIdList=' + brandId + '&brandText=' + brandText + '&goodTextBox=' + goodTextBox + '&rnd=' + Math.random());
