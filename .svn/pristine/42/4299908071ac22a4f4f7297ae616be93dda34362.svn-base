...
namespace XHD.BLL
{
    ...
    {
        private readonly XHD.DAL.shop_order_goods dal = new XHD.DAL.shop_order_goods();
        ...
        /// 得到一个对象实体，从缓存中
        /// </summary>
        public XHD.Model.shop_order_goods GetModelByCache(int ordergood_id)
        {
            ...
            return (XHD.Model.shop_order_goods)objModel;
        }
        ...
        {
            return dal.GetCurGoods(strWhere, limit, user_id);
        }
        ...
        {
            return dal.GetEmpSaleGoods(strWhere, limit);
        }
        ...
        /// 获得数据列表
        /// </summary>
        public List<XHD.Model.shop_order_goods> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<XHD.Model.shop_order_goods> DataTableToList(DataTable dt)
        {
            List<XHD.Model.shop_order_goods> modelList = new List<XHD.Model.shop_order_goods>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                XHD.Model.shop_order_goods model;
