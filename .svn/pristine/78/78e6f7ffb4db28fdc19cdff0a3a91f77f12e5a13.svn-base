    ...
    <script type="text/javascript">
        ...
        function doserch() {
            ...
            $.ajax({
                ...
                data: { Action: "getProvinceYear_Months", provinceId: provinceId, yearMonth: syear, brandIdList: brandIdList, goodTextBox: goodTextBox, rnd: Math.random() },
                dataType: 'json',
            ...
            $.ajax({
                ...
                async: false,
                url: "../Reports_DMS.ashx",
                data: { Action: "getProvinceMonth_Brand", provinceId: provinceId, yearMonth: syear, brandIdList: brandIdList, goodTextBox: goodTextBox, rnd: Math.random() },
                dataType: 'json',
                success: function (data) {
                    if (data) {
            ...
            $.ajax({
                ...
                async: false,
                url: "../Reports_DMS.ashx",
                data: { Action: "getProvinceMonth_City", provinceId: provinceId, yearMonth: syear, brandIdList: brandIdList, goodTextBox: goodTextBox, rnd: Math.random() },
                dataType: 'json',
                success: function (data) {
                    if (data) {
            ...
            $.ajax({
                ...
                async: false,
                url: "../Reports_DMS.ashx",
                data: { Action: "getProvinceMonth_Good", provinceId: provinceId, yearMonth: syear, brandIdList: brandIdList, goodTextBox: goodTextBox, rnd: Math.random() },
                dataType: 'json',
                success: function (data) {
                    if (data) {
            ...
            $.ajax({
                ...
                async: false,
                url: "../Reports_DMS.ashx",
                data: { Action: "getProvinceMonth_Emp", provinceId: provinceId, yearMonth: syear, brandIdList: brandIdList, goodTextBox: goodTextBox, rnd: Math.random() },
                dataType: 'json',
                success: function (data) {
                    if (data) {
            ...
            $.ajax({
                ...
                async: false,
                url: "../Reports_DMS.ashx",
                data: { Action: "getProvinceMonth_Customer", provinceId: provinceId, yearMonth: syear, brandIdList: brandIdList, goodTextBox: goodTextBox, rnd: Math.random() },
                dataType: 'json',
                success: function (data) {
                    if (data) {
