    ...
    <script type="text/javascript">
        ...
        function doserch() {
            ...
            $.ajax({
                ...
                data: { Action: "getCustomerMonthBrandGoodsSaleBackData", admin_user_name: admin_user_name, user_id: user_id, brand_id: brand_id, yearMonth: yearMonth, rnd: Math.random() },
                dataType: 'json',
