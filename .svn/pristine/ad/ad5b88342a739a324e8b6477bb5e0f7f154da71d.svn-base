...
{
    /// <summary>
    /// 数据访问类:dms_set_ratingDAO
    /// </summary>
    public partial class dms_set_ratingDAO
    {
        public dms_set_ratingDAO()
        { }
        #region  BasicMethod
        /// <summary>
        /// 是否存在该记录
        ...
        public bool Exists(int plan_id)
        {
            ...
            strSql.Append("select count(1) from dms_set_rating");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into dms_set_rating(");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update dms_set_rating set ");
        ...
        public bool Delete(int plan_id)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from dms_set_rating ");
            strSql.Append(" where plan_id=@plan_id");
            MySqlParameter[] parameters = {
					new MySqlParameter("@plan_id", MySqlDbType.Int32)
			};
        ...
        public XHD.Model.dms_set_rating GetModel(int plan_id)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select plan_id,plan_year,plan_task,plan_jan,plan_feb,plan_mar,plan_apr,plan_may,plan_jun,plan_jul,plan_aug,plan_sep,plan_oct,plan_nov,plan_dec,kf_rname,kf_uname from dms_set_rating ");
            strSql.Append(" where plan_id=@plan_id");
            MySqlParameter[] parameters = {
					new MySqlParameter("@plan_id", MySqlDbType.Int32)
			};
            ...
            XHD.Model.dms_set_rating model = new XHD.Model.dms_set_rating();
        ...
        /// 得到一个对象实体
        /// </summary>
        public XHD.Model.dms_set_rating DataRowToModel(DataRow row)
        {
            XHD.Model.dms_set_rating model = new XHD.Model.dms_set_rating();
            if (row != null)
            {
        ...
        public DataSet GetList(string strWhere)
        {
            ...
            strSql.Append(" FROM dms_set_rating ");
            if (strWhere.Trim() != "")
            {
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(")AS Row, T.*  from dms_set_rating T ");
        ...
        public DataSet GetList(int PageSize,int PageIndex,string strWhere)
        {
            ...
            parameters[0].Value = "dms_set_rating";
        ...
        public DataSet GetList(int PageSize, int PageIndex, string strWhere, string filedOrder, out string Total)
        {
            ...
            strSql.Append(" select * FROM dms_set_rating ");
            strSql1.Append(" select count(*) FROM dms_set_rating ");
            if (strWhere.Trim() != "")
            {
                strSql.Append(" where " + strWhere);
