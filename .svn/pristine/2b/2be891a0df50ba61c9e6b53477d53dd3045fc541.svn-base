...
function showQuarterPoint() {
    if (quarterChaData[quarter_two1 - 1].value > 0) {
        getPoint('1季度奖', axisData[quarter_two1 - 1], quarterDataColor[quarter_two1 - 1][0]);
    }
    if (quarterChaData[quarter_three1 - 1].value > 0) {
        getPoint('2季度奖', axisData[quarter_three1 - 1], quarterDataColor[quarter_three1 - 1][0]);
    }
    if (quarterChaData[quarter_four1 - 1].value > 0) {
        getPoint('3季度奖', axisData[quarter_four1 - 1], quarterDataColor[quarter_four1 - 1][0]);
    }
    if (quarterChaData[monthcount - 1].value > 0) {
        getPoint('4季度奖', axisData[monthcount - 1], quarterDataColor[monthcount - 1][0]);
    }
