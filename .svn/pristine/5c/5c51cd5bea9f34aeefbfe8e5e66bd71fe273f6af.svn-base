...
namespace XHD.Model
{
    public class NewShop_SysParams
    {
    ...
    public class NewShop_OrderAddParams : NewShop_SysParams
    {
        #region Model
        private int _order_id;
        public List<shop_order_goods> goods { set; get; }
    ...
    public class Content
    {
        ...
        public string wms_order_sn { set; get; }
        public string erp_order_sn { set; get; }
        public string cwerp_order_sn { set; get; }
        public string user_id { set; get; }
        public string order_status { set; get; }
        public string shipping_status { set; get; }
        ...
        public string user_market_area { set; get; }
        ...
        public string shipping_id { set; get; }
        public string shipping_name { set; get; }
        public string is_no_shipping_fee { set; get; }
        public string pay_id { set; get; }
        public string pay_name { set; get; }
        public string trans_bank_id { set; get; }
        public string trans_bank_name { set; get; }
        public string inv_payee { set; get; }
        public string inv_content { set; get; }
        public string goods_amount { set; get; }
        public string shipping_fee { set; get; }
        public string insure_fee { set; get; }
        public string pay_fee { set; get; }
        public string pack_fee { set; get; }
        public string money_paid { set; get; }
        public string surplus { set; get; }
        public string integral { set; get; }
        public string integral_money { set; get; }
        public string bonus { set; get; }
        public string order_amount { set; get; }
        public string from_ad { set; get; }
        public string referer { set; get; }
        public string add_time { set; get; }
        public string confirm_time { set; get; }
        public string pay_time { set; get; }
        public string shipping_time { set; get; }
        public string pack_id { set; get; }
        public string card_id { set; get; }
        public string bonus_id { set; get; }
        public string invoice_no { set; get; }
        public string to_buyer { set; get; }
        public string pay_note { set; get; }
        public string agency_id { set; get; }
        public string inv_type { set; get; }
        public string tax { set; get; }
        public string discount { set; get; }
        public string wuliu_id { set; get; }
        public string wuliu_name { set; get; }
        public string need_inv { set; get; }
        public string is_send2_erp { set; get; }
        public string is_send2_cwerp { set; get; }
        public string is_wuliu_img { set; get; }
        public string get_pay_type { set; get; }
        public string is_daifa { set; get; }
        public string is_no_qingdan { set; get; }
        public string admin_user_id { set; get; }
        public string admin_user_name { set; get; }
        public string admin_user_real_name { set; get; }
        public string send_user_name { set; get; }
        public string send_user_tel { set; get; }
        public string send_user_company { set; get; }
        public string send_user_address { set; get; }
        public string cangku_id { set; get; }
        public string payinfo_pic { set; get; }
        public string is_confirm_remind { set; get; }
        public string is_print_remind { set; get; }
        public string order_ip { set; get; }
        public string cwerp_time { set; get; }
        public string erp_time { set; get; }
        public string is_need_review { set; get; }
        public string review_info { set; get; }
        public string Operator { set; get; }
        public string det_stats { set; get; }
        public string dealer_id { set; get; }
        public string is_show_price { set; get; }
        public string operator_user_id { set; get; }
        public string invoice_weight { set; get; }
        public string order_confirm_info { set; get; }
        public string invoice_id { set; get; }
        public string wms_setbook_id { set; get; }
        public string wms_doc_id { set; get; }
        public string wms_account_flag { set; get; }
        public string wms_receive_note { set; get; }
        public string wms_flow_no { set; get; }
        public string wms_finish_amout { set; get; }
        public string wms_unfinish_amout { set; get; }
        public string wms_invoice_type { set; get; }
        public string wms_account_type { set; get; }
        public string wms_voucher { set; get; }
        public string wms_amount { set; get; }
        public string wms_storage { set; get; }
        public string supply_user_id { set; get; }
        public string is_invoice_advance { set; get; }
    }
