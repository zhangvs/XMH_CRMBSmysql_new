...
{ 
    ...
    public partial class shop_invoices_among_goods
    {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append(" select o.order_sn,g.goods_name as g_name,g.goods_invoice_name,i.*,n.invoice_status,n.refund_money,p.pay_name,b.brand_id,b.brand_name FROM shop_invoices_among_goods  i  ");
