...
{
    /// <summary>
    /// 数据访问类:ecs_total_planDAO
    /// </summary>
    public partial class ecs_total_planDAO
    {
        public ecs_total_planDAO()
        { }
        #region  BasicMethod
        /// <summary>
        /// 是否存在该记录
        ...
        public bool Exists(int plan_id)
        {
            ...
            strSql.Append("select count(1) from ecs_total_plan");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("insert into ecs_total_plan(");
            strSql.Append("plan_task,plan_divide,plan_jan,plan_feb,plan_mar,plan_apr,plan_may,plan_jun,plan_jul,plan_aug,plan_sep,plan_oct,plan_nov,plan_dec)");
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("update ecs_total_plan set ");
            ...
            parameters[12].Value = model.plan_nov;
            parameters[13].Value = model.plan_dec;
            parameters[14].Value = model.plan_id;
        ...
        public bool Delete(int plan_id)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("delete from ecs_total_plan ");
            strSql.Append(" where plan_id=@plan_id");
            MySqlParameter[] parameters = {
					new MySqlParameter("@plan_id", MySqlDbType.Int32)
			};
        ...
        public XHD.Model.ecs_total_plan GetModel(int plan_id)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select plan_id,plan_task,plan_divide,plan_jan,plan_feb,plan_mar,plan_apr,plan_may,plan_jun,plan_jul,plan_aug,plan_sep,plan_oct,plan_nov,plan_dec from ecs_total_plan ");
            strSql.Append(" where plan_id=@plan_id");
            MySqlParameter[] parameters = {
					new MySqlParameter("@plan_id", MySqlDbType.Int32)
			};
            ...
            XHD.Model.ecs_total_plan model = new XHD.Model.ecs_total_plan();
        ...
        /// 得到一个对象实体
        /// </summary>
        public XHD.Model.ecs_total_plan DataRowToModel(DataRow row)
        {
            XHD.Model.ecs_total_plan model = new XHD.Model.ecs_total_plan();
            if (row != null)
            {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select plan_id,plan_task,plan_divide,plan_jan,plan_feb,plan_mar,plan_apr,plan_may,plan_jun,plan_jul,plan_aug,plan_sep,plan_oct,plan_nov,plan_dec ");
            strSql.Append(" FROM ecs_total_plan ");
            if (strWhere.Trim() != "")
            {
        ...
        public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
        {
            ...
            strSql.Append(")AS Row, T.*  from ecs_total_plan T ");
        ...
        public DataSet GetList(int PageSize,int PageIndex,string strWhere)
        {
            ...
            parameters[0].Value = "ecs_total_plan";
