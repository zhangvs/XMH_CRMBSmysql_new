...
namespace XHD.DAL.wms
{
    ...
    public partial class dqkcyl
    {
        ...
        public bool Exists(long ID)
        {
            ...
            strSql.Append("select count(1) from xmh_wms.dqkcyl");
        ...
        public XHD.Model.wms.dqkcyl GetModel(long ID)
        {
            ...
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select BM,PM,ZTIDH,CD,DW,SL,DJ,HW,SCCJ,GUIGE,JE,JBZ,XSJ,XSJJE,MH,ID,SGZ_KC,SGZ_PdDate from xmh_wms.dqkcyl ");
            strSql.Append(" where ID=@ID ");
            MySqlParameter[] parameters = {
					new MySqlParameter("@ID", MySqlDbType.Int32,20)			};
            parameters[0].Value = ID;
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append("select *  FROM xmh_wms.dqkcyl ");
            if (strWhere.Trim() != "")
            {
