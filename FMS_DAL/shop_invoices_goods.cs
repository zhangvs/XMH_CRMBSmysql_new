...
namespace FMS_DAL
{
    ...
    public partial class shop_invoices_goods
    {
        ...
        {
            StringBuilder strSql = new StringBuilder();
            strSql.Append(" select g.goods_name as g_name,g.goods_invoice_name,i.*,n.refund_money,b.brand_id,b.brand_name,g.goods_id,g.tax_cat_code FROM shop_invoices_goods  i  "); //p.pay_name,
