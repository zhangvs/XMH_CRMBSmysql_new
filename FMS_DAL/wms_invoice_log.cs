...
{
	/// <summary>
	/// 数据访问类:wms_invoice_log
	/// </summary>
	public partial class wms_invoice_log
	{
		public wms_invoice_log()
		{}
		#region  BasicMethod
		...
		public bool Exists(long id)
		{
			...
			strSql.Append("select count(1) from wms_invoice_log");
		...
		/// 增加一条数据
		/// </summary>
		public bool Add(FMS_Model.wms_invoice_log model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into wms_invoice_log(");
			strSql.Append("id,inv_id,inv_sn,emp_code,emp_name,log_info,log_time)");
			...
			parameters[1].Value = model.inv_id;
			parameters[2].Value = model.inv_sn;
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(FMS_Model.wms_invoice_log model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update wms_invoice_log set ");
			strSql.Append("inv_id=@inv_id,");
		...
		public bool Delete(long id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from wms_invoice_log ");
			strSql.Append(" where id=@id ");
			MySqlParameter[] parameters = {
					new MySqlParameter("@id", MySqlDbType.Int64,20)			};
			parameters[0].Value = id;
		...
		/// 得到一个对象实体
		/// </summary>
		public FMS_Model.wms_invoice_log GetModel(long id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,inv_id,inv_sn,emp_code,emp_name,log_info,log_time from wms_invoice_log ");
			strSql.Append(" where id=@id ");
			MySqlParameter[] parameters = {
					new MySqlParameter("@id", MySqlDbType.Int64,20)			};
			parameters[0].Value = id;

			FMS_Model.wms_invoice_log model=new FMS_Model.wms_invoice_log();
		...
		/// 得到一个对象实体
		/// </summary>
		public FMS_Model.wms_invoice_log DataRowToModel(DataRow row)
		{
			FMS_Model.wms_invoice_log model=new FMS_Model.wms_invoice_log();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,inv_id,inv_sn,emp_code,emp_name,log_info,log_time ");
			strSql.Append(" FROM wms_invoice_log ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from wms_invoice_log T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "wms_invoice_log";
