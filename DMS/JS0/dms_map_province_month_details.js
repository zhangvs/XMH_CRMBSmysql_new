...
function doserch() {
    ...
    $.ajax({
        ...
        data: { Action: "getProvinceMonth_Brand", provinceId: provinceId, syear: syear, smonth: smonth, brandIdList: brandIdList, goodId: goodId, goodTextBox: goodTextBox, rnd: Math.random() },
        dataType: 'json',
    ...
    $.ajax({
        ...
        async: false,
        url: "../Reports_DMS.ashx",
        data: { Action: "getProvinceMonth_City", provinceId: provinceId, syear: syear, smonth: smonth, brandIdList: brandIdList, goodId: goodId, goodTextBox: goodTextBox, rnd: Math.random() },
        dataType: 'json',
        success: function (data) {
            if (data) {
    ...
    $.ajax({
        ...
        async: false,
        url: "../Reports_DMS.ashx",
        data: { Action: "getProvinceMonth_Good", provinceId: provinceId, syear: syear, smonth: smonth, brandIdList: brandIdList, goodId: goodId, goodTextBox: goodTextBox, rnd: Math.random() },
        dataType: 'json',
        success: function (data) {
            if (data) {
    ...
    $.ajax({
        ...
        async: false,
        url: "../Reports_DMS.ashx",
        data: { Action: "getProvinceMonth_Emp", provinceId: provinceId, syear: syear, smonth: smonth, brandIdList: brandIdList, goodId: goodId, goodTextBox: goodTextBox, rnd: Math.random() },
        dataType: 'json',
        success: function (data) {
            if (data) {
    ...
    $.ajax({
        ...
        async: false,
        url: "../Reports_DMS.ashx",
        data: { Action: "getProvinceMonth_Customer", provinceId: provinceId, syear: syear, smonth: smonth, brandIdList: brandIdList, goodId: goodId, goodTextBox: goodTextBox, rnd: Math.random() },
        dataType: 'json',
        success: function (data) {
            if (data) {
