    ...
    $("#goodTxt").autocomplete({
        ...
        source: function (request, response) {
            $.ajax({
                ...
                data: { Action: "getMonthGoodTxt", brandIdList: brandId, syear: syear, smonth: $("#smonth").val(), keyWord: request.term, rnd: Math.random() },
                dataType: "json",
...
function doserch() {
    ...
    $.ajax({
        type: "post",
        url: "../Reports_DMS.ashx",
        data: { Action: "getMonthProvinceAmt", brandIdList: brandId, goodId: goodId, goodTextBox: goodTextBox, syear: syear, smonth: smonth, rnd: Math.random() },
        ...
        success: function (data) {
            if (data) {
                ...
                options.title[0].text = '新明辉' + smonth + '月份各省份销售分布';
                if (brandId == '' && goodTextBox == '') {
...
function DrawEChart(ec) {
    ...
    myChart.on('click', function (params) {
        window.open('/DMS/ReportForm/dms_map_province_month_details.aspx?syear=' + $("#syear").val() + '&smonth=' + $("#smonth").val() + '&provinceId=' + params.data.id + '&provinceName=' + params.data.name + '&provinceValue=' + params.data.value + '&brandIdList=' + brandId + '&brandText=' + brandText + '&goodId=' + goodId + '&goodTextBox=' + goodTextBox + '&rnd=' + Math.random());

        //f_openWindow('/DMS/ReportForm/dms_map_province_month_Brandprovince.aspx?syear=' + $("#syear").val() + '&smonth=' + $("#smonth").val() + '&provinceId=' + params.data.id + '&provinceName=' + params.data.name + '&provinceValue=' + params.data.value + '&rnd=' + Math.random(), "省份详情", 1800, 1000);//宽度，高度
