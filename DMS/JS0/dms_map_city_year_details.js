...
function doserch() {
    ...
    $.ajax({
        ...
        data: { Action: "getCityYear_Months", CityId: CityId, syear: syear, brandIdList: brandIdList, goodId: goodId, goodTextBox: goodTextBox, rnd: Math.random() },
        dataType: 'json',
    ...
    $.ajax({
        ...
        async: false,
        url: "../Reports_DMS.ashx",
        data: { Action: "getCityMonth_Brand", CityId: CityId, syear: syear, brandIdList: brandIdList, goodId: goodId, goodTextBox: goodTextBox, rnd: Math.random() },
        dataType: 'json',
        success: function (data) {
            if (data) {
    ...
    $.ajax({
        ...
        async: false,
        url: "../Reports_DMS.ashx",
        data: { Action: "getCityMonth_Good", CityId: CityId, syear: syear, brandIdList: brandIdList, goodId: goodId, goodTextBox: goodTextBox, rnd: Math.random() },
        dataType: 'json',
        success: function (data) {
            if (data) {
    ...
    $.ajax({
        ...
        async: false,
        url: "../Reports_DMS.ashx",
        data: { Action: "getCityMonth_Emp", CityId: CityId, syear: syear, brandIdList: brandIdList, goodId: goodId, goodTextBox: goodTextBox, rnd: Math.random() },
        dataType: 'json',
        success: function (data) {
            if (data) {
    ...
    $.ajax({
        ...
        async: false,
        url: "../Reports_DMS.ashx",
        data: { Action: "getCityMonth_Customer", CityId: CityId, syear: syear, brandIdList: brandIdList, goodId: goodId, goodTextBox: goodTextBox, rnd: Math.random() },
        dataType: 'json',
        success: function (data) {
            if (data) {
...
function DrawEChart() {
    ...
    var options = {
        title: {
            text: CityName + '市' + syear + '年度各月份销量对比',
        },
        grid: {
            x: 200,//靠左200像素
            x2: 200,//靠右200像素
    ...
    var options = {
        title: {
            text: CityName + '市' + syear + '年度热门单品（Top100）',
        },
        grid: {
            x: 180,//靠左200像素
            x2: 180,//靠右200像素
    ...
    var options = {
        title: {
            text: CityName + '市' + syear + '年度客户（Top100）',
        },
        grid: {
            x: 180,//靠左200像素
            x2: 180,//靠右200像素
