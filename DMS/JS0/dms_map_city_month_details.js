...
function doserch() {
    ...
    $.ajax({
        ...
        data: { Action: "getCityMonth_Brand", CityId: CityId, syear: syear, smonth: smonth, brandIdList: brandIdList, goodId: goodId, goodTextBox: goodTextBox, rnd: Math.random() },
        dataType: 'json',
    ...
    $.ajax({
        ...
        async: false,
        url: "../Reports_DMS.ashx",
        data: { Action: "getCityMonth_Good", CityId: CityId, syear: syear, smonth: smonth, brandIdList: brandIdList, goodId: goodId, goodTextBox: goodTextBox, rnd: Math.random() },
        dataType: 'json',
        success: function (data) {
            if (data) {
    ...
    $.ajax({
        ...
        async: false,
        url: "../Reports_DMS.ashx",
        data: { Action: "getCityMonth_Emp", CityId: CityId, syear: syear, smonth: smonth, brandIdList: brandIdList, goodId: goodId, goodTextBox: goodTextBox, rnd: Math.random() },
        dataType: 'json',
        success: function (data) {
            if (data) {
    ...
    $.ajax({
        ...
        async: false,
        url: "../Reports_DMS.ashx",
        data: { Action: "getCityMonth_Customer", CityId: CityId, syear: syear, smonth: smonth, brandIdList: brandIdList, goodId: goodId, goodTextBox: goodTextBox, rnd: Math.random() },
        dataType: 'json',
        success: function (data) {
            if (data) {
