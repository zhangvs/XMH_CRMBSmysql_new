...
function showMonthQuarterData() {
    for (var i = 0; i < d_pids.length; i++) {
        ...
        if (quarterChaData[i][quarter_two1 - 1].value > 0) {
            getPoint(quarterPoint[i], '1季度奖', quarter_two1 - 1, quarterDataColor[i][quarter_two1 - 1][0]);
        }
        if (quarterChaData[i][quarter_three1 - 1].value > 0) {
            getPoint(quarterPoint[i], '2季度奖', quarter_three1 - 1, quarterDataColor[i][quarter_three1 - 1][0]);
        }
        if (quarterChaData[i][quarter_four1 - 1].value > 0) {
            getPoint(quarterPoint[i], '3季度奖', quarter_four1 - 1, quarterDataColor[i][quarter_four1 - 1][0]);
        }
        if (quarterChaData[i][monthcount - 1].value > 0) {
            getPoint(quarterPoint[i], '4季度奖', length - 1, quarterDataColor[i][monthcount - 1][0]);
        }
    }
}
