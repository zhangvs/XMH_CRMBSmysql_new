...
<head>
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            $("#maingrid4").ligerGrid({
                columns: [
                    ...
                    { display: '计划', name: 'plan_task', width: 100, align: 'right' },
                ...
                dataAction: 'server',
                pageSize: 31, pageSizeOptions: [ 30, 60, 90],
                url: "../DMS_Set.ashx?Action=getPerPlan&rnd=" + Math.random(),
        ...
        function doserch() {
            ...
            var sendtxt = "&Action=getPerPlan&idlist=" + tree0 + "&rnd=" + Math.random();
        ...
        function edit() {
            ...
            if (row) {
                ...
                $("input[name='plan_jan']").val(row.plan_mar);
                $("input[name='plan_feb']").val(row.plan_apr);
        ...
        function Confirm() {
            ...
            var sendtxt = '';
            if (plan_id != '') {
                sendtxt = "&Action=updatePerPlan";
            }
            else {
                sendtxt = "&Action=addPerPlan";
            }
                ...
                $.ligerDialog.confirm("确定要删除吗？", function (yes) {
                    if (yes) {
                        $.ajax({
                            ...
                            data: { Action: "deletePerPlan", plan_id: row.plan_id, rnd: Math.random() },
                            success: function (responseText) {
                                if (responseText == "4") {
...
<body>
    <form id="form1" onsubmit="return false">
        ...
        <div class="dialog open" id="prodown" style="display: none; position: fixed; width:400px; z-index: 9999; background: #fff;">
            <div class="dialog-head" id="dhead1"><span class="close rotate-hover" style="cursor: pointer" onclick="closeDivs();">X</span><strong id="titlsAll">年计划设置</strong></div>
