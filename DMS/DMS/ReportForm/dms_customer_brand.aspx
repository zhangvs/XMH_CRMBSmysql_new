...
<head>
    ...
    <script src="../../JS/dmsCustomerBrand.js" type="text/javascript"></script>
     <style type="text/css">
        table.dataView {
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            month_count = decodeURI(getparastr("month_count"));
            month_frequency = decodeURI(getparastr("month_frequency"));
        ...
        function doserch() {
            ...
            $.ajax({
                ...
                data: { Action: "getCustomerMonthBrandSaleBackData", admin_user_name: admin_user_name, user_id: user_id, syear: syear, smonth: smonth, rnd: Math.random() },
                dataType: 'json',
