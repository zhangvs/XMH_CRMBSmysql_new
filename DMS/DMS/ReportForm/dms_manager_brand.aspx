    ...
    <script type="text/javascript">
        ...
        function doserch() {
            ...
            $.ajax({
                ...
                data: { Action: "getBrandCheck_Manager", idlist: tree0, brandIdList: tree1, smonth: smonth, rnd: Math.random() },
                dataType: 'json',
            ...
            $.ajax({
                ...
                async: false,
                url: "../Reports_DMS.ashx",
                data: { Action: "getBrandSaleBackData_Manager", idlist: tree0, brandIdList: tree1, syear: syear, smonth: smonth, rnd: Math.random() },
                dataType: 'json',
                success: function (responseText) {
