...
<head>
    ...
    <script src="../../JS/dmsBrandQuarter.js" type="text/javascript"></script>
     <style type="text/css">
        table.dataView {
    ...
    <script type="text/javascript">
        ...
        function doserch() {
            ...
            $.ajax({
                ...
                data: { Action: "getYearBrandCheck", brandIdList: tree1, rnd: Math.random() },
                dataType: 'json',
            ...
            $.ajax({
                ...
                async: false,
                url: "../Reports_DMS.ashx",
                data: { Action: "getYearBrandSaleBackData", brandIdList: tree1, syear: syear, rnd: Math.random() },
                dataType: 'json',
                success: function (responseText) {
