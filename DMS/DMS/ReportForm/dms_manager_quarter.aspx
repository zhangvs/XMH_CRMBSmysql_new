...
<head>
    ...
    <script src="../../JS/dmsQuarterManager.js" type="text/javascript"></script>
     <style type="text/css">
        table.dataView {
            ...
            $.ajax({
                ...
                success: function (responseText) {
                    if (responseText.Total == "0") {
                        ...
                        if (typeof (responseText.monthBasePlan) != "undefined") {
                            getMonthBasePlanData(responseText.monthBasePlan);//计划线
                        }
                        else {
                            $.ligerDialog.warn('未设置计划基数！');
                        }
