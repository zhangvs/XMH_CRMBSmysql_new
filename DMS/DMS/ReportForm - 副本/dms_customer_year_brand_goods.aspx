...
<head>
    ...
    <script src="../../JS/dmsCustomerYearBrandGoods.js" type="text/javascript"></script>
     <style type="text/css">
        table.dataView {
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            user_name = decodeURI(getparastr("user_name"));
            goods_id = decodeURI(getparastr("goods_id"));
            syear = decodeURI(getparastr("syear"));
            u_company = decodeURI(getparastr("u_company"));
        ...
        function doserch() {
            ...
            $.ajax({
                ...
                data: { Action: "getCustomerYearGood", user_id: user_id,user_name:user_name, goods_id: goods_id, yearMonth: yearMonth, rnd: Math.random() },
                dataType: 'json',
                success: function (responseText) {
                    if (typeof (responseText) != "undefined") {
                        getDateCount(syear, u_company);
                        getCustomerYearGood(responseText);//数据
                        DrawEChartCustomer();
                    }
                },
                error: function () {
