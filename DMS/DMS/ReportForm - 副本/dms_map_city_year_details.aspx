    ...
    <script type="text/javascript">
        ...
        function doserch() {
            ...
            $.ajax({
                ...
                data: { Action: "getCityYear_Months", CityId: CityId, yearMonth: syear, brandIdList: brandIdList, goodTextBox: goodTextBox, rnd: Math.random() },
                dataType: 'json',
            ...
            $.ajax({
                ...
                async: false,
                url: "../Reports_DMS.ashx",
                data: { Action: "getCityMonth_Brand", CityId: CityId, yearMonth: syear, brandIdList: brandIdList, goodTextBox: goodTextBox, rnd: Math.random() },
                dataType: 'json',
                success: function (data) {
                    if (data) {
            ...
            $.ajax({
                ...
                async: false,
                url: "../Reports_DMS.ashx",
                data: { Action: "getCityMonth_Good", CityId: CityId, yearMonth: syear, brandIdList: brandIdList, goodTextBox: goodTextBox, rnd: Math.random() },
                dataType: 'json',
                success: function (data) {
                    if (data) {
            ...
            $.ajax({
                ...
                async: false,
                url: "../Reports_DMS.ashx",
                data: { Action: "getCityMonth_Emp", CityId: CityId, yearMonth: syear, brandIdList: brandIdList, goodTextBox: goodTextBox, rnd: Math.random() },
                dataType: 'json',
                success: function (data) {
                    if (data) {
            ...
            $.ajax({
                ...
                async: false,
                url: "../Reports_DMS.ashx",
                data: { Action: "getCityMonth_Customer", CityId: CityId, yearMonth: syear, brandIdList: brandIdList, goodTextBox: goodTextBox, rnd: Math.random() },
                dataType: 'json',
                success: function (data) {
                    if (data) {
