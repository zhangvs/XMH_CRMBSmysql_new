...
<head>
    ...
    <script src="../../JS/dmsCustomerYear.js" type="text/javascript"></script>
     <style type="text/css">
        table.dataView {
    ...
    <script type="text/javascript">
        ...
        function initSelect() {
            ...
            $('#tree1').ligerComboBox({
                ...
                //checkbox: true,
                tree: {
                    url: '../Reports_DMS.ashx?Action=getCustomerTree&admin_user_name=' + admin_user_name + '&yearMonth=' + yearMonth + '&rnd=' + Math.random(),
                    idFieldName: 'id',
        ...
        function doserch() {
            ...
            $.ajax({
                ...
                data: { Action: "getCustomerYearSaleBackData", admin_user_name: admin_user_name, customerIdList: tree1, yearMonth: yearMonth, rnd: Math.random() },
                dataType: 'json',
