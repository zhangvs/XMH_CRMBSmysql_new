...
namespace FMS_BLL
{
    ...
    public partial class fms_kuan_adjust
    {
        ...
        {
            return dal.Updates(id, erpCode, time, debit_account_code, credit_account_code);
        }
        ...
        {
            return dal.updateStatus(status, idList, remark);
        }
        ...
        {
            return dal.adopt(idList, empId, time);
        }
