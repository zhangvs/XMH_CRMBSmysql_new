...
namespace FMS_BLL
{
    ...
    {
        private readonly FMS_DAL.mp dal = new FMS_DAL.mp();
        public mp()
        { }
        #region  BasicMethod
        ...
        /// 得到一个对象实体，从缓存中
        /// </summary>
        public FMS_Model.mp GetModelByCache(int ID)
        {

            string CacheKey = "mpModel-" + ID;
        ...
        /// 获得数据列表
        /// </summary>
        public List<FMS_Model.mp> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<FMS_Model.mp> DataTableToList(DataTable dt)
        {
            List<FMS_Model.mp> modelList = new List<FMS_Model.mp>();
        ...
        {
            return dal.GetListGroupByProvince(PageSize, PageIndex, strWhere, filedOrder, out Total);
        }
        ...
        {
            return dal.GetListGroupByCity(PageSize, PageIndex, strWhere, filedOrder, province, out Total);
        }
        ...
        {
            return dal.GetListByCity(PageSize, PageIndex, strWhere, filedOrder, city_id, out Total);
        }
