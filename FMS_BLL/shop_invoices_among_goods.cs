...
namespace FMS_BLL
{
    ...
    { 
        ...
        private readonly FMS_DAL.shop_invoices_among_goods dal = new FMS_DAL.shop_invoices_among_goods();
        ...
        /// 得到一个对象实体，从缓存中
        /// </summary>
        public FMS_Model.shop_invoices_among_goods GetModelByCache(int id)
        {
            ...
            return (FMS_Model.shop_invoices_among_goods)objModel;
        }
        ...
        /// 获得数据列表
        /// </summary>
        public List<FMS_Model.shop_invoices_among_goods2> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<FMS_Model.shop_invoices_among_goods2> DataTableToList(DataTable dt)
        {
            List<FMS_Model.shop_invoices_among_goods2> modelList = new List<FMS_Model.shop_invoices_among_goods2>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                FMS_Model.shop_invoices_among_goods2 model;
