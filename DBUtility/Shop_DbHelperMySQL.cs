...
namespace XHD.DBUtility
{
    ...
    /// Copyright (C) XHD
    /// </summ
    public abstract class Shop_DbHelperMySQL
    {
         //数据库连接字符串(web.config来配置)，可以动态更改connectionString支持多数据库.		
        public static string connectionString = PubConstant.ConnectionStringShop;
        public Shop_DbHelperMySQL()
        {
        ...
        public static object GetSingles(string SQLString)
        {
            using (MySqlConnection connection = new MySqlConnection(connectionString))
            {
                using (MySqlCommand cmd = new MySqlCommand(SQLString, connection))
