...
namespace XHD.BLL
{
    ...
    {
        private readonly XHD.DAL.ecs_goods_attr dal = new XHD.DAL.ecs_goods_attr();
        ...
        {
            return dal.Exists(goods_attr_id);
        }
        ...
        {
            return dal.DeleteList(goods_attr_idlist);
        }
        ...
        public XHD.Model.ecs_goods_attr GetModel(int goods_attr_id)
        {
            ...
            return dal.GetModel(goods_attr_id);
        }

        /// <summary>
        /// 得到一个对象实体，从缓存中
        /// </summary>
        public XHD.Model.ecs_goods_attr GetModelByCache(int goods_attr_id)
        {

            string CacheKey = "ecs_goods_attrModel-" + goods_attr_id;
            object objModel = XHD.Common.DataCache.GetCache(CacheKey);
            if (objModel == null)
            {
                try
                {
                    objModel = dal.GetModel(goods_attr_id);
                    if (objModel != null)
                    {
            ...
            return (XHD.Model.ecs_goods_attr)objModel;
        }
        ...
        /// 获得数据列表
        /// </summary>
        public List<XHD.Model.ecs_goods_attr> GetModelList(string strWhere)
        {
        ...
        /// 获得数据列表
        /// </summary>
        public List<XHD.Model.ecs_goods_attr> DataTableToList(DataTable dt)
        {
            List<XHD.Model.ecs_goods_attr> modelList = new List<XHD.Model.ecs_goods_attr>();
            int rowsCount = dt.Rows.Count;
            if (rowsCount > 0)
            {
                XHD.Model.ecs_goods_attr model;
