...
{
    /// <summary>
    /// crm_task_okrs:实体类(属性说明自动提取数据库字段的描述信息)
    /// </summary>
    [Serializable]
    public partial class crm_task_okrs
    {
        ...
        /// 
        /// </summary>
        public int? task_parent_Id
        {
            set { _task_parent_id = value; }
            get { return _task_parent_id; }
        }
        /// <summary>
        /// 
        /// </summary>
        ...
        {
            set { _delegate_id = value; }
            get { return _delegate_id; }
        }
        /// <summary>
        /// 
        /// </summary>
