...
{
    /// <summary>
    /// scm_supply_goods:实体类(属性说明自动提取数据库字段的描述信息)
    /// </summary>
    [Serializable]
    public partial class scm_supply_goods
    {
        ...
        private int? _isdelete_copy = 0;

        public string file_ip { set; get; }
        /// <summary>
        /// 
        /// </summary>
        public int goods_id
        ...
        {
            set { _update_reason = value; }
            get { return _update_reason; }
        }
        /// <summary>
        /// 
        /// </summary>
        ...
        /// 
        /// </summary>
        public int? isDelete_copy
        {
            set { _isdelete_copy = value; }
            get { return _isdelete_copy; }
        }
        #endregion Model
