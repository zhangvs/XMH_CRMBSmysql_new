...
{
	/// <summary>
	/// shop_points_order:实体类(属性说明自动提取数据库字段的描述信息)
	/// </summary>
	[Serializable]
	public partial class shop_points_order
	{
		...
		private decimal _goods_integral_amount;
		...
		/// 积分商品总价
		/// </summary>
		public decimal goods_integral_amount
		{
			set{ _goods_integral_amount=value;}
			get{return _goods_integral_amount;}
		}
		/// <summary>
		/// 配送时间：1工作日，2仅周末，3任何时间
		/// </summary>
		public int? time_id
		{
			set{ _time_id=value;}
